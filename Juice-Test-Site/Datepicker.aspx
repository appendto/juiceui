...
<asp:content contentplaceholderid="_Content" runat="server">
  ...
  <Juice:Datepicker runat="server" TargetControlID="DoB" DayNames="Domingo,Lunes,Martes,Miercoles,Jueves,Viernes,Sabado" 
        ButtonImage="/images/calendar-icon.png" ButtonImageOnly="true"
        ShowOn="both" ButtonText="Show date picker" />
</asp:content>